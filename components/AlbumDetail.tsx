...
export const AlbumDetail: React.FC<AlbumDetailProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-zinc-800/50 to-black p-4 md:p-8 overflow-y-auto animate-in fade-in zoom-in-95 duration-500">
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-end mb-8">
        <img
          src={album.image}
          alt={album.name}
          className="w-48 h-48 md:w-64 md:h-64 rounded-md shadow-2xl mx-auto md:mx-0"
        />
        <div className="flex flex-col gap-2 text-center md:text-left w-full md:w-auto">
          <span className="text-xs font-bold uppercase tracking-wider">
            Album
          </span>
          <h1 className="text-4xl md:text-8xl font-black">{album.name}</h1>
